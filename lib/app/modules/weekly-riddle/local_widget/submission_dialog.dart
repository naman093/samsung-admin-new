...
import '../../../models/riddle_submission_model.dart';
import '../controllers/weekly_riddle_controller.dart';

class SubmissionDialogView extends GetView<WeeklyRiddleController> {
  final RiddleSubmissionModel submission;
  final SolutionType type;
  final VideoPlayerController? videoController;

  const SubmissionDialogView({
    super.key,
                          ...
                          _actionButton(
                            ...
                            onTap: () async {
                              ...
                              try {
                                ...
                                bool v = await controller.weeklyRiddleRepo
                                    .verifySubmission(
                                      status: false,
                                ...
                                if (v) {
                                  Get.back();
                                  await controller.fetchWeeklyRiddleSubmissions(
